...
api_lazer = Ossapi(getenv('osu_client_id'), getenv('osu_client_secret'),domain="lazer")
...
class osu(commands.GroupCog, name=module.cog_name):
    ...
    async def recent(self, interaction: discord.Interaction, user:str,mode:Optional[Literal["osu!","osu!taiko","osu!catch","osu!mania"]],lazer:Optional[Literal["Yes","No"]]):        
